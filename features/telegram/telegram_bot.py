GREETING_MESSAGE = "Привет! Я OpenAI бот. Используйте мои навыки для помощи в своей работе."
NOT_ALLOWED_MESSAGE = "Извините, вас нет в списке пользователей. Для организации доступа заполните заявку: https://forms.gle/t7JASHwBCi3nJqRd6"
GROUP_NOT_ALLOWED_MESSAGE = "Извините, не нашел данную группу в списке доступных. Для организации доступа заполните заявку: https://forms.gle/pWSSMmBkB1gAhkrF6"
